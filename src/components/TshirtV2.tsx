...
export default function TshirtCanvas() {
  ...
  return (
    <div className="flex items-center flex-col lg:flex-row gap-4 w-full bg-white justify-between lg:pl-[5vw] h-fit lg:h-screen">
      ...
      <div className="flex flex-col flex-wrap gap-4 w-full lg:w-[50%] items-center justify-center bg-amber-300 h-full p-4">
        <div className="flex gap-2">
          ...
          <button onClick={() => changeColor("#f0b100")} className="px-4 py-2 bg-yellow-500 text-black w-[10vw] h-[10vw] rounded-4xl cursor-pointer">Yellow</button>
        </div>
        <div className="flex gap-2">
